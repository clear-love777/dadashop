# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2020-01-04 11:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_image_url', models.ImageField(default=None, upload_to='sku_default/', verbose_name='默认图片')),
            ],
            options={
                'verbose_name': 'SKU表',
        ...
        migrations.AddField(
            model_name='saleattrvalue',
            name='sku',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='goods.SKU', verbose_name='sku'),
        ),
    ]
